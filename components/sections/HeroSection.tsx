  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden relative">
      ...
      >
        ...
        >
          <span className="text-sm company-text-tertiary font-medium">Scroll</span>
          <svg className="w-6 h-6 company-text-tertiary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
          </svg>
        </motion.div>
      </motion.div>
